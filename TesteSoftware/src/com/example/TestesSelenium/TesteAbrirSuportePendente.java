...
public class TesteAbrirSuportePendente {
  ...
  @Test
  public void testEAbrirSuportePendente() throws Exception {
    ...
    driver.findElement(By.xpath("//form[@id='form']/div/button")).click();
    assertEquals("Criado", driver.findElement(By.linkText("Criado")).getText());
    driver.findElement(By.cssSelector("div[title=\"Elipse Software - Matriz\"]")).click();
